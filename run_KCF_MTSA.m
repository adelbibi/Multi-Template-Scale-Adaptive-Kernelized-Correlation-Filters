function results = run_KCF_MTSA(seq, res_path, bSaveImage)
	...
	padding = 1.7;  %extra area surrounding the target
    ...
    features, 0,mu, maxitr, mu_inc, step_sc);
